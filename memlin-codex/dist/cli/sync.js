...
var RESOLVER_SKILL_DIR = path14.join(os11.homedir(), ".claude", "skills", "memlin");
var RESOLVER_SKILL_FILE = path14.join(RESOLVER_SKILL_DIR, "SKILL.md");
...
function inferTitle(relPath, content) {
  ...
  return path15.basename(relPath, path15.extname(relPath));
}
main().catch((err) => {
